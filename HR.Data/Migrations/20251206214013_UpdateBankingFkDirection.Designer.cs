...
namespace HR.Data.Migrations
{
    ...
    [Migration("20251206214013_UpdateBankingFkDirection")]
    partial class UpdateBankingFkDirection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR.Data.Models.BANKING.BankDetail", b =>
                {
                    ...
                    b.HasOne("HR.Data.Models.BANKING.PaymentData", "PaymentData")
                        .WithOne("BankDetail")
                        .HasForeignKey("HR.Data.Models.BANKING.BankDetail", "PaymentDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
